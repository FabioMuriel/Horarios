<?php
  $id=$_SESSION["sesion_active"]["id_aprendiz"];
  $cargo=$_SESSION["sesion_active"]["tipo_usuario"];
  $login = new LoginControlador();
  $datos= $login -> DatosUsuarioAprendiz($id);
  $ficha=$datos["id_ficha"];
?>
    ...
    <input type="hidden" value="<?php echo $id;?>" name="idSesionAp" id="idSesionAp">
    <input type="hidden" value="<?php echo $ficha;?>" name="fichaAP" id="fichaAP">
