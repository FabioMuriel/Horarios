  ...
  <script src="public/assets/js/main.js?n=17"></script>
  <script src="public/assets/js/Personal.js?n=17"></script>
  <script src="public/assets/js/Horario.js?n=17"></script>
  <script src="public/assets/js/Configuracion.js?n=17"></script>
  <script src="public/assets/js/Fidelizacion.js?n=17"></script>
  <script src="public/assets/js/Reportes.js?n=17"></script>
  <script src="public/assets/js/SGP.js?n=17"></script>
  <script src="public/assets/js/Autoreporte.js?n=17"></script>
  <script src="public/assets/js/Ingreso.js?n=17"></script>
  <script src="public/assets/vendor/botonesDatatable/js/dataTables.buttons.min.js"></script>
  <script src="public/assets/vendor/botonesDatatable/js/buttons.html5.min.js"></script>
  <script src="public/assets/vendor/pdfDatatable/vfs_fonts.js"></script>
  <script src="public/assets/vendor/zip/jszip.min.js"></script>
  <script src="public/assets/js/multiselect.js"></script>
